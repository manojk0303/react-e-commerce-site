...
function App() {
  ...
  return (
    <Router>    
      <div className="App">
        {isLoggedIn && <Navbar cartCount={cartCount} setIsLoggedIn={setIsLoggedIn} isLoggedIn={isLoggedIn}/>}
        <Routes>
         

            <Route element={<PrivateRoutes condition={!isLoggedIn} redirectTo="/"/>}>
            <Route path='/login' element={<Login setIsLoggedIn={setIsLoggedIn} uid={uid} seturEmail={seturEmail} setUid={setUid} />} />
            <Route path='/signup' element={<Signup setIsLoggedIn={setIsLoggedIn} uid={uid} seturEmail={seturEmail} setUid={setUid} />} />
            </Route>

          
          <Route element={<PrivateRoutes condition={isLoggedIn} redirectTo="/login"/>}>
            <Route path="/" index exact element={<Products cartClicked={cartClicked} cartItems={cartItems} cartCount={cartCount} uremail={uremail} fbProducts={fbProducts} setFbProducts={setFbProducts} setCartCount={setCartCount} setCartItems={setCartItems} />} />
            <Route path="/dresses/:dressSku" exact element={<DressPage cartClicked={cartClicked} fbProducts={fbProducts} />} />
            <Route path="/checkout" exact element={<Checkout fbProducts={fbProducts} orderedItems={orderedItems} setOrderedItems={setOrderedItems} uremail={uremail}  cartCount={cartCount} setCartCount={setCartCount} cartItems={cartItems} setCartItems={setCartItems} totalPrice={totalPrice} setTotalPrice={setTotalPrice} />} />
